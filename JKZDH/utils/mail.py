...
class SendMail:
    def __init__(self, send_msg,
                 ...
                 sender="Duanlinbo123@163.com", #17620395200@163.com
                 psw="SYXAAPMABUNKMKQK", receiver="Duanlinbo123@163.com",
                 #psw是我们授权码，不是我们的登录密码
                 port=25, attachment=None):
                 # smtpserver="smtp.exmail.qq.com",
                 # sender="fuxiangyong@duoceshi.com",  # 17620395200@163.com
                 # psw="Fxy345201", receiver="fuxiangyong@duoceshi.com",
                 # # psw是我们的登录密码
                 # port=25, attachment=None):
